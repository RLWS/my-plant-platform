...
public class UserController1 {
    ...
    public String userRegister(@Autowired(required = true) User user) throws IOException {
        HashMap<String, Object> map = new HashMap<>(10);
        user.setPower(1);
    ...
    public String registerEmail(User user) throws IOException {
        return SerializeUtils.serialize(BaseResult.success(userService.selectByPrimaryKey(user) == null));
    }
