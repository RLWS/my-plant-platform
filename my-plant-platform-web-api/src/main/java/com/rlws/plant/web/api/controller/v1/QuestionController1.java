package com.rlws.plant.web.api.controller.v1;
...
public class QuestionController1 {
    ...
    public String startUp(HttpServletRequest request) throws IOException {
        return SerializeUtils.serialize(BaseResult.success());
    }
    ...
    public String userClickTitle(HttpServletRequest request, @Autowired(required = true) int id) throws IOException {
        System.out.println("-----------------");
        ...
        if (optimal != 0) {
            ...
            map.put("optimal", answer);
        }
        map.put("questionAnswerCount", i);
        map.put("allAnswer", allAnswer);
        map.put("question", question);
        map.put("questions", questions);
        map.put("pageView", "details");
        return SerializeUtils.serialize(BaseResult.success(map));
    }
