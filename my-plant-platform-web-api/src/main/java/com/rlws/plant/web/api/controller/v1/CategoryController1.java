...
public class CategoryController1 {
    ...
    public String getListCategoryQuestionAjax(int category_id, int page_current, int page_size) throws IOException {
        ...
        return SerializeUtils.serialize(BaseResult.success(JSON.toJSONString(map)));
    }
